                               ...
                               for ($I = 0; $I < $countqr; $I++) {
                                   ...
                                   for ($i = 0; $i < ($num_field); $i++) {
                                       ...
                                       if ($i < ($num_field - 2)) {
                                           ...
                                           if ($i = ($num_field - 2)) {
                                               echo "<td align='center'>"?>
                                               <a href="#" onClick="window.open('content/add_<?=$this->process?>.php?method=edit&id=<?= $this->sslEnc($query[$c][$field[$i]])?>','','width=600,height=700'); return false;" title="Update ข้อมูล BILLDISP จาก HOS">
                                               <img src='images/icon_set1/document_edit.ico' width='25'></a></td>
                                          <?php }
                                           if ($i = ($num_field - 1)) {
                                               ...
                                               echo "<td align='center'>";
                                               ?>
                                               <a href="index.php?page=process/prc<?= $this->process ?>&method=delete_<?= $this->process ?>&del_id=<?php echo $this->sslEnc($query[$c][$field[$i]])?>" onClick="return confirm('กรุณายืนยันการลบอีกครั้ง !!!')" target="_blank">
                                                <?php
                                                echo "<img src='images/icon_set1/document_delete.ico' width='25'></a></td>";
                                            }
                                        }
